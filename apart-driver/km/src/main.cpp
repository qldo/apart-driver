...
NTSTATUS driver_main(PDRIVER_OBJECT driver_object, PUNICODE_STRING registry_path) {
	...
	RtlInitUnicodeString(&device_name, L"\\Device\\ApartDriver");
	...
	RtlInitUnicodeString(&symbolic_link, L"\\DosDevices\\ApartDriver");
	...
	// Allows us to send small amount of data between um/km.
...
NTSTATUS DriverEntry() {
	debug_print("[+] Sub from kernel!\n");

	UNICODE_STRING driver_name = {};
	RtlInitUnicodeString(&driver_name, L"\\Driver\\ApartDriver");
